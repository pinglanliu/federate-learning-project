...
plt.savefig(f'./results/cifar/iid-evenly-split/periodically-fixed-users/train_accuracy_{args.epochs}_{args.model}_{len(idxs_users)}.png')
...
plt.savefig(f'./results/cifar/iid-evenly-split/periodically-fixed-users/test_accuracy_{args.epochs}_{args.model}_{len(idxs_users)}.png')
