...
args = args_parser()
sys.stdout = Logger("./logs/cifar_non_iid.log")
...
plt.savefig(f'./results/cifar/non-iid/train_accuracy_{args.epochs}_{args.model}_{len(idxs_users)}.png')
...
plt.savefig(f'./results/cifar/non-iid/test_accuracy_{args.epochs}_{args.model}_{len(idxs_users)}.png')